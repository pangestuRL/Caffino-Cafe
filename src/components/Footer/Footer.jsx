...
function Footer (){
    ...
    return (
        <div className='flex flex-col pt-10'>
            <div className="flex md:flex-row bg-[#E5CFB5] px-20">
                <div className='p-10 flex-1 justify-items-center'>
                    <img className='' src={peopple} alt="peopple"/>
                    <p><span className="text-[#3E2723] font-bold text-center">Pangestu Riski Lestari</span><br/>FrontEnd Developer</p>
                </div>
                <div className='p-4 flex-1 py-8'>
                        <p className='text-[#3E2723] font-bold'>“Every time I come here, I always feel at home. The coffee is incredibly delicious, 
            ...
            <div className='flex flex-col md:flex-row bg-[#3E2723] px-20'>
                <div className='p-10 px-20 flex-1 justify-items-start'>
                    ...
                    <p className="text-white">Copyright © 2024 Caffino Caffe by Pangestu <br/>All Rights Reserved
                    </p>
                </div>
                <div className='p-4 flex-1 py-8'>
